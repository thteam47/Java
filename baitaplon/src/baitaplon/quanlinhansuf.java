 ...
 * @author Admin
 */
public class quanlinhansuf extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setText("Quản lí thông tin liên quan");
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baitaplon/icon1/pngegg (12).png"))); // NOI18N
        jButton7.setText("Quản lí phòng ban");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (cv == null) {
            tblNhanSu.removeAll();
            cv = new congviec();
            tblNhanSu.add("Quản lí công việc", cv);
            cv=null;
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (hs == null) {
            tblNhanSu.removeAll();
            hs = new hoso();
            tblNhanSu.add("Hồ sơ nhân sự", hs);
            hs=null;
        }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
         if (pb == null) {
            tblNhanSu.removeAll();
            pb = new phongban();
            tblNhanSu.add("Quản lí phòng ban", pb);
            pb=null;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quanlinhansuf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new quanlinhansuf().setVisible(true);
            }
        });
    }
